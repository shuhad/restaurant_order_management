...
Route::group(['middleware' => 'languange'], function()
{
	...
	Route::resource('expense-category', 'CategoryController');

	Route::resource('reports/receivings', 'ReceivingReportController');
	Route::resource('reports/sales', 'SaleReportController');
	Route::resource('reports/expense', 'ExpenseReportController');
	Route::post('reports/searched', 'SaleReportController@searched');
	Route::post('reports/receivingsearched', 'ReceivingReportController@receivingsearched');
	Route::get('reports/clearreceived', 'ReceivingReportController@clearreceived');
	Route::get('reports/deletesale', 'SaleReportController@deletesale');
	Route::post('reports/expensesearched', 'ExpenseReportController@expensesearched');
