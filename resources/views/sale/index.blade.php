                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-9">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>@{{newsaletemp.item.size}}</td>
                            <td>BDT @{{newsaletemp.item.selling_price }}</td><td><input type="text" style="text-align:center" autocomplete="off" name="quantity" ng-change="updateSaleTemp(newsaletemp)" ng-model="newsaletemp.quantity" size="2"></td><td>BDT @{{newsaletemp.item.selling_price * newsaletemp.quantity }}</td><td><button class="btn btn-danger btn-xs" type="button" ng-click="removeSaleTemp(newsaletemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                            </tr>
                        </table>
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="add_payment" name="payment_value" ng-model="add_payment" required="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><b>BDT @{{sum(saletemp) }}</b></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                            <p class="form-control-static">BDT @{{add_payment - sum(saletemp) }}</p>
                                            </div>
                                    </div>
