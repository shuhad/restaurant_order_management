                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-9">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>@{{newreceivingtemp.item_id}}</td><td>@{{newreceivingtemp.item.item_name}}</td><td>BDT @{{newreceivingtemp.item.cost_price }}</td><td><input type="text" style="text-align:center" autocomplete="off" name="quantity" ng-change="updateReceivingTemp(newreceivingtemp)" ng-model="newreceivingtemp.quantity" size="2"></td><td>BDT @{{newreceivingtemp.item.cost_price * newreceivingtemp.quantity}}</td><td><button class="btn btn-danger btn-xs" type="button" ng-click="removeReceivingTemp(newreceivingtemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                            </tr>
                        </table>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="total" class="col-sm-5 control-label">Amount Paid <!-- {{trans('receiving.amount_tendered')}} --></label>
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                                <div class="input-group-addon">BDT </div>
                                                <input type="text" class="form-control" id="amount_tendered" name="paidAmount" />
                                            </div>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><b>BDT @{{sum(receivingtemp)}}</b></p>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                                    <div class="form-group">
